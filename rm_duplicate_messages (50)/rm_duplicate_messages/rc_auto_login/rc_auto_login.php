...
try {
    ...
    if (isset($_GET['logout'])) {
        // Переменные "$isLoggedIn" показывают статус входа: "true" - вход выоплнен, "false" - вход не выоплнен.
