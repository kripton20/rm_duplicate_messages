        ...
        */
        ...
        if ($key == "msg2") {
            ...
            if ($msg2 >= $msg_sum_uids) {
                ...
                * Функция session_start() создаёт сессию, либо возобновляет существующую, основываясь на
                * идентификаторе сессии, переданном через GET- или POST-запрос, либо переданный через cookie.
                */
            }
            session_start();
        ...
        if ($msg1 >= $msg_sum_uids - 1) {
            ...
            */
            ...
            $args .= "list_page=" . $this->rc->storage->list_page . "\n";
            // Вызываем функцию записи лог - файла.
            $this->write_log_file($args);
            // Удалим ранее созданные наши записи (настройки поиска и обработки писем)
            // - в массиве пользовательских настроек 'prefs'.
