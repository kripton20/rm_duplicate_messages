...
/**
    ...
    */
    частный $rcSessionAuth;

    /**
    * Сохранить текущий статус сеанса Roundcube.
    * 0 = неизвестно, 1 = вход в систему, -1 = вход не выполнен.
    *
    * @var целое
    */
    частный $rcLoginStatus;
    ...
    *
    * @param string Относительный путь веб-сервера к установке RC, например. /круглый куб/
