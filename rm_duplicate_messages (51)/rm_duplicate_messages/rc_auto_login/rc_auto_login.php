...
function msg_request($rcl)
{
    ...
    $data = " ";
    // В цикле выполняем // Периодически методом POST вызываем на выполнение функцию "msg_request".
    for ($i = 0; $i <= 10; $i++) {
    ...
    //    $fp1 = $rcl->sendRequest($rcl->rcPath . "?_task = mail & _mbox = INBOX");
    //
